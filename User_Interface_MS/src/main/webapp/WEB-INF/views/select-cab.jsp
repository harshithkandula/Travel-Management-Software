...
<body>
      ...
      <form action="schedule-ride" method="post" modelAttribute="ride">
                                 ...
                                 <input type="text" class="form-control" name="source" value="${r.getSource()}" style="width:300px"><br><br>
                                   ...
                                   <label class="form-label" for="exampleInputCabType">Choose Cab</label>
                                   <select name="cabId" style="width:300px">
                                         <option>-select-</option>
                                         <c:forEach items="${cabs}" var="c">
                                              <option value="${c.getCabId()}">${c.getDriverName()}-${c.getVehicleType()}</option>
                                         </c:forEach>
                                   </select><br><br>
